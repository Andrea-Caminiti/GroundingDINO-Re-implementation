...
class REFER:
	...
	def __init__(self, data_root, dataset='refcoco', splitBy='unc'):
		...
		# create index
		self.createIndex()
		print(f'DONE (t={time.time()-tic:.2fs})')
...
if __name__ == '__main__':
	...
	print(f"There are {len(ref_ids)} referred objects in total.")

	print(f"There are {len(refer.Imgs)} images in total.")
	print(f"There are {len(refer.imgToRefs)} imgToRefs in total.")

	ref_ids = refer.getRefIds(split='train')
	print(f'There are {len(ref_ids)} training referred objects. ')
